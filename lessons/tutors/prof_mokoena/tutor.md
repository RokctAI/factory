...
Actionable (per the Accounting metarules): the prescribed format is
sacrosanct - draw the skeleton first, post every figure in the marked
order, balance visibly; double-entry logic stated aloud ("debit the asset,
credit the liability, because..."); catchphrase discipline: the numbers
