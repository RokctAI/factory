...
class ManufacturingCostsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b10_l1 = MathTex(r"400 \text{ units: } \tfrac{600}{400} = 1{,}50 \;\Rightarrow\; \text{R}4{,}50").scale(1.0).shift(band_shift(10) + UP * 1.1)
        self.play(Write(b10_l1))
        self.wait(2.5)
        b10_l2 = MathTex(r"600 \text{ units: } \tfrac{600}{600} = 1{,}00 \;\Rightarrow\; \text{R}4{,}00").scale(1.0).shift(band_shift(10) + UP * 0.1)
        self.play(Write(b10_l2))
        self.wait(2.5)
        b10_l3 = MathTex(r"200 \text{ units: } \tfrac{600}{200} = 3{,}00 \;\Rightarrow\; \text{R}6{,}00").scale(1.0).shift(band_shift(10) + DOWN * 0.9)
