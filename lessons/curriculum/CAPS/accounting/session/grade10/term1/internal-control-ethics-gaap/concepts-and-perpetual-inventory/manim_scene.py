...
class ConceptsAndPerpetualInventorySession(MovingCameraScene):
    ...
    def construct(self):
        ...
        b2_l5 = Tex(r"Profit and Loss $\Rightarrow$ net profit $\Rightarrow$ Capital").scale(1.0).shift(band_shift(2) + DOWN * 2.5)
        ...
        self.wait(2)
        b6_l3 = MathTex(r"\text{Gap} = \text{R48 000} - \text{R46 500} = \text{R1 500}").scale(1.1).shift(band_shift(6) + DOWN * 0.8)
        ...
        self.wait(2)
        b9_l5 = MathTex(r"\text{Gross profit} = \text{R500} - \text{R300} = \text{R200}").scale(1.1).shift(band_shift(9) + DOWN * 2.3)
