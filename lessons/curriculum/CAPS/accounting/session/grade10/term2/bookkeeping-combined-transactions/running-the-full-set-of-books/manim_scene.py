...
class RunningTheFullSetOfBooksSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2.5)
        b0_l3 = Tex(r"Money in $\Rightarrow$ CRJ; money out $\Rightarrow$ CPJ").scale(1.05).shift(DOWN * 0.5)
        b0_l4 = Tex(r"Credit sale $\Rightarrow$ DJ; credit purchase $\Rightarrow$ CJ").scale(1.0).shift(DOWN * 1.4)
        ...
        self.wait(2)
        b8_l1 = Tex(r"Money in? $\Rightarrow$ CRJ. Money out? $\Rightarrow$ CPJ").scale(1.0).shift(band_shift(8) + UP * 1.1)
        b8_l2 = Tex(r"Trust out? $\Rightarrow$ DJ. Trust in? $\Rightarrow$ CJ").scale(1.0).shift(band_shift(8) + UP * 0.3)
        b8_l3 = Tex(r"Coming back? $\Rightarrow$ DAJ / CAJ. Else $\Rightarrow$ GJ").scale(1.0).shift(band_shift(8) + DOWN * 0.5)
