...
class AssetMovementsAndAuditorsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b3_l3 = MathTex(r"\text{Age} = \frac{\text{acc. depreciation}}{\text{annual charge}}").scale(1.1).shift(band_shift(3) + DOWN * 0.6)
        ...
        b9_l2 = MathTex(r"\frac{630\,000 \text{ worn}}{90\,000 \text{ a year}} = 7 \text{ years old}").scale(1.05).shift(band_shift(9) + UP * 0.0)
