...
class VatControlAndSarsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2.5)
        b0_l3 = Tex(r"Exclusive R2\,000: VAT $= 15\% = $ R300").scale(1.05).shift(DOWN * 0.4)
        b0_l4 = MathTex(r"\text{Inclusive } 2\,300 \times \tfrac{15}{115} = R300").scale(1.05).shift(DOWN * 1.3)
        self.play(Write(b0_l3))
        self.wait(2)
        self.play(Write(b0_l4))
        self.play(Create(SurroundingRectangle(b0_l4, color=GREEN)))
        self.wait(2)
        b0_wrong = MathTex(r"15\% \times 2\,300 = R345").scale(1.0).shift(DOWN * 2.2)
        ...
        self.next_band(1)
        b1_title = Tex("Jabulani Hardware: one VAT period").scale(1.15).shift(band_shift(1) + UP * 2.2)
        self.play(Write(b1_title))
        self.wait(1.5)
        b1_l1 = Tex(r"Sales R460\,000 excl.\ $\Rightarrow$ output R69\,000").scale(1.0).shift(band_shift(1) + UP * 1.2)
        b1_l2 = Tex(r"Purchases R320\,000 excl.\ $\Rightarrow$ input R48\,000").scale(1.0).shift(band_shift(1) + UP * 0.4)
        self.play(Write(b1_l1))
        self.wait(2.5)
        self.play(Write(b1_l2))
        self.wait(2.5)
        b1_l3 = Tex(r"Plain difference: R21\,000 — but it never ends there").scale(0.95).shift(band_shift(1) + DOWN * 0.5)
        self.play(Write(b1_l3))
        self.wait(2)
        b1_l4 = Tex(r"Returns R20\,000: output $-$ R3\,000").scale(1.0).shift(band_shift(1) + DOWN * 1.4)
        b1_l5 = Tex(r"Drawings R6\,000: owed $+$ R900").scale(1.0).shift(band_shift(1) + DOWN * 2.2)
        b1_l6 = Tex(r"Bad debts R9\,200 incl.: $\tfrac{15}{115} =$ R1\,200 relief").scale(0.95).shift(band_shift(1) + DOWN * 3.0)
        ...
        self.wait(1.5)
        b2_l1 = MathTex(r"\text{Output: } 69\,000 - 3\,000 + 900 = 66\,900").scale(1.05).shift(band_shift(2) + UP * 1.1)
        b2_l2 = MathTex(r"\text{Input: } 48\,000 + 1\,200 = 49\,200").scale(1.05).shift(band_shift(2) + UP * 0.2)
        self.play(Write(b2_l1))
        self.wait(2.5)
        self.play(Write(b2_l2))
        self.wait(2.5)
        b2_l3 = MathTex(r"66\,900 - 49\,200 = R17\,700 \text{ payable}").scale(1.1).shift(band_shift(2) + DOWN * 0.8)
        ...
        self.wait(2)
        b3_c1 = Tex(r"Opening balance 12\,400").scale(0.8).shift(band_shift(3) + UP * 0.6 + RIGHT * 2.3)
        self.play(Write(b3_c1))
        self.wait(1.5)
        b3_d1 = Tex(r"Bank (payment) 12\,400").scale(0.8).shift(band_shift(3) + UP * 0.6 + LEFT * 2.3)
        self.play(Write(b3_d1))
        self.wait(1.5)
        b3_c2 = Tex(r"Output tax 69\,000").scale(0.8).shift(band_shift(3) + UP * 0.0 + RIGHT * 2.3)
        b3_c3 = Tex(r"Drawings 900").scale(0.8).shift(band_shift(3) + DOWN * 0.6 + RIGHT * 2.3)
        self.play(Write(b3_c2))
        self.play(Write(b3_c3))
        self.wait(2)
        b3_d2 = Tex(r"Input tax 48\,000").scale(0.8).shift(band_shift(3) + UP * 0.0 + LEFT * 2.3)
        b3_d3 = Tex(r"Returns 3\,000").scale(0.8).shift(band_shift(3) + DOWN * 0.6 + LEFT * 2.3)
        b3_d4 = Tex(r"Bad debts 1\,200").scale(0.8).shift(band_shift(3) + DOWN * 1.2 + LEFT * 2.3)
        self.play(Write(b3_d2))
        self.play(Write(b3_d3))
        self.play(Write(b3_d4))
        self.wait(2)
        b3_bal = Tex(r"Balance: CREDIT R17\,700 — a current liability").scale(0.95).shift(band_shift(3) + DOWN * 2.5)
        ...
        self.next_band(5)
        b5_title = Tex("The R3 that was never MaDlamini's").scale(1.15).shift(band_shift(5) + UP * 2.2)
        self.play(Write(b5_title))
        self.wait(2)
        b5_l1 = Tex(r"Washing powder R23 $=$ R20 shop $+$ R3 SARS").scale(1.0).shift(band_shift(5) + UP * 1.2)
        self.play(Write(b5_l1))
        self.wait(2.5)
        b5_l2 = Tex(r"Before-tax R200: $+15\% \Rightarrow$ R30 tax, R230 shelf").scale(0.95).shift(band_shift(5) + UP * 0.3)
        b5_l3 = MathTex(r"\text{Shelf } 23 \times \tfrac{15}{115} = R3").scale(1.05).shift(band_shift(5) + DOWN * 0.6)
        ...
        self.wait(2)
        b5_l4 = Tex("Brown bread, maize meal: zero-rated;").scale(0.95).shift(band_shift(5) + DOWN * 2.4)
        b5_l5 = Tex("her backroom rent: exempt — never in the building").scale(0.95).shift(band_shift(5) + DOWN * 3.1)
        ...
        self.wait(2)
        b6_l1 = Tex(r"Collected: $15\% \times 46\,000 = $ R6\,900").scale(1.0).shift(band_shift(6) + UP * 1.2)
        b6_l2 = Tex(r"Paid to vendors: $15\% \times 32\,000 = $ R4\,800").scale(1.0).shift(band_shift(6) + UP * 0.4)
        self.play(Write(b6_l1))
        self.wait(2)
        self.play(Write(b6_l2))
        self.wait(2)
        b6_l3 = MathTex(r"6\,900 - 4\,800 = R2\,100 \text{ owed}").scale(1.05).shift(band_shift(6) + DOWN * 0.5)
        ...
        self.wait(2)
        b7_wrong = Tex("The cousin's advice: keep two tills").scale(1.0).shift(band_shift(7) + UP * 1.2)
