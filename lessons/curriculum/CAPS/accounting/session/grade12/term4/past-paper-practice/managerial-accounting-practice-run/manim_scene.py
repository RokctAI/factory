...
class ManagerialAccountingPracticeRunSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(1.5)
        b2_l1 = MathTex(r"\frac{1\,260\,000}{21\,000 \text{ units}} = R60 \text{ per unit}").scale(1.1).shift(band_shift(2) + UP * 0.9)
        ...
        b7_l4 = MathTex(r"9\,200 \times \tfrac{15}{115} = 1\,200 \;\Rightarrow\; 28\,500 + 900 - 1\,200").scale(0.9).shift(band_shift(7) + DOWN * 1.2)
