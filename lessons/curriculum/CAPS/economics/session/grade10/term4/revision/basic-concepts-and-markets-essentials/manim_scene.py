...
class BasicConceptsMarketsRevisionSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0c = Tex("Three questions: WHAT $\\cdot$ HOW $\\cdot$ FOR WHOM").scale(1.05).shift(DOWN * 1.5)
        self.play(Write(b0c))
        self.wait(2)
        ...
        b3b = Tex("Inject in: investment $\\cdot$ govt spending $\\cdot$ exports").scale(1.05).shift(band_shift(3) + UP * 0.3)
        self.play(Write(b3a))
        self.wait(2)
        self.play(Write(b3b))
