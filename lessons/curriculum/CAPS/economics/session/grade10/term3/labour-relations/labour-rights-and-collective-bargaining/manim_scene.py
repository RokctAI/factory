...
class LabourRightsCollectiveBargainingSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(b5t))
        self.wait(2)
        r5a = Rectangle(width=4.2, height=1.5).shift(band_shift(5) + UP * 0.7 + LEFT * 4.4)
        t5a = Tex("Union\\\\organises + negotiates").scale(0.85).move_to(r5a.get_center())
        self.play(Create(r5a), Write(t5a))
        self.wait(1.5)
        r5b = Rectangle(width=4.2, height=1.5).shift(band_shift(5) + UP * 0.7 + RIGHT * 4.4)
        t5b = Tex("Bargaining council\\\\sector-level negotiation").scale(0.85).move_to(r5b.get_center())
        self.play(Create(r5b), Write(t5b))
        self.wait(1.5)
        r5c = Rectangle(width=4.6, height=1.5).shift(band_shift(5) + DOWN * 1.3)
        t5c = Tex("Workplace forum\\\\consults in one workplace").scale(0.85).move_to(r5c.get_center())
