...
class SectorsInfrastructureSASession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(b1b))
        self.wait(2)
        b1c = Tex("Primary smallest: mining $\\approx$ 6\\%, agriculture $\\approx$ 3\\%").scale(1.0).shift(band_shift(1) + DOWN * 0.5)
        self.play(Write(b1c))
        self.wait(2)
        ...
        self.play(Write(b8c))
        self.wait(2)
        b8d = Tex("Of every R100: services $\\approx$ R65, factories $\\approx$ R20,").scale(0.95).shift(band_shift(8) + DOWN * 1.4)
