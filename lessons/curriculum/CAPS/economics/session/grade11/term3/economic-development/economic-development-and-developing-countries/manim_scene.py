...
class EconomicDevelopmentSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        g2 = Tex("Development: a QUALITY statement — lives improved").scale(1.05).shift(UP * 0.2)
        self.play(Write(g1))
        self.wait(2)
        self.play(Write(g2))
        self.wait(2.5)
        g3 = Tex("Oil-rich, unschooled, unwell: growth WITHOUT development").scale(0.95).shift(DOWN * 0.8)
        self.play(Write(g3))
        self.wait(2)
