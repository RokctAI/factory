...
class MarketRelationshipsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(r1))
        self.wait(2)
        r2 = MathTex(r"\text{Relative price: } \frac{70}{140} = \text{half the price of beef}").scale(1.05).shift(UP * 0.1)
        self.play(Write(r2))
        self.wait(2.5)
        ...
        self.wait(1.5)
        c1 = Tex(r"Phones cheaper $\Rightarrow$ more users $\Rightarrow$ data demand RIGHT").scale(0.9).shift(band_shift(3) + UP * 1.3)
        self.play(Write(c1))
        self.wait(2.5)
