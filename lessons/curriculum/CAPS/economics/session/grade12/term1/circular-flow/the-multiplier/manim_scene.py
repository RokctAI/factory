...
class TheMultiplierSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(cf))
        self.wait(2)
        mpc = MathTex(r"MPC = \frac{\Delta C}{\Delta Y}, \quad MPS = \frac{\Delta S}{\Delta Y}").scale(1.1).shift(DOWN * 1.7)
        self.play(Write(mpc))
        self.wait(2)
        ...
        self.play(Write(s1))
        self.wait(2.5)
        s2 = MathTex(r"\text{Sum} = \frac{1\,000}{1 - 0{,}8} = \frac{1\,000}{0{,}2} = R5\,000").scale(1.1).shift(band_shift(2) + UP * 0.0)
        self.play(Write(s2))
        self.wait(2.5)
        ...
        self.play(Write(n3))
        self.wait(2)
        rev = MathTex(r"\text{Exports} - R5\text{ bn}, \; k=2: \; \Delta Y = -R10\text{ bn}").scale(1.0).shift(band_shift(6) + DOWN * 1.4)
        self.play(Write(rev))
