...
class PerfectCompetitionOutputProfitsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(1.5)
        b5_l1 = Tex("Profit $\\Rightarrow$ entry, supply right, P falls").scale(1.05).shift(band_shift(5) + UP * 1.4)
        b5_l2 = Tex("Loss $\\Rightarrow$ exit, supply left, P rises").scale(1.05).shift(band_shift(5) + UP * 0.5)
