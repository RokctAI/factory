...
class PerimeterAreaVolumeContextSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(l01))
        self.wait(2)
        l02 = MathTex(r"3{,}5 \text{ m} = 350 \text{ cm}; \quad 2\,400 \text{ mm} = 2{,}4 \text{ m}").scale(1.0).shift(UP * 0.5)
        self.play(Write(l02))
        self.wait(2)
        l03 = MathTex(r"\text{Area factor squared: } 1 \text{ m}^2 = 10\,000 \text{ cm}^2").scale(1.0).shift(DOWN * 0.4)
        l04 = MathTex(r"\text{Volume cubed: } 1 \text{ m}^3 = 1\,000\,000 \text{ cm}^3").scale(1.0).shift(DOWN * 1.3)
        self.play(Write(l03))
        self.wait(2)
        self.play(Write(l04))
        self.wait(2)
