...
class BankingAndBankChargesSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2.5)
        b11_l2 = MathTex(r"\text{Quiet month: } \text{R}34{,}50 \text{ vs } \text{R}55 \Rightarrow \text{pay-as-you-go}").scale(0.68).shift(band_shift(11) + UP * 0.1)
        b11_l3 = MathTex(r"\text{Busy month: } \text{R}150{,}50 \text{ vs } \text{R}55 \Rightarrow \text{bundle}").scale(0.74).shift(band_shift(11) + DOWN * 0.9)
