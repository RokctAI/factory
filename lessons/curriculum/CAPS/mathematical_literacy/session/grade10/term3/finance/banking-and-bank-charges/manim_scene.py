...
class BankingAndBankChargesSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2.5)
        b6_l3 = MathTex(r"6 \text{ withdrawals: } \text{R}6{,}50 + \text{R}42 = \text{R}48{,}50").scale(1.0).shift(band_shift(6) + DOWN * 0.8)
        b6_l4 = MathTex(r"7 \text{ withdrawals: } \text{R}6{,}50 + \text{R}49 = \text{R}55{,}50").scale(1.0).shift(band_shift(6) + DOWN * 1.7)
        ...
        b10_l3 = MathTex(r"\text{Year at the counter: } 52 \times \text{R}70 = \text{R}3\;640").scale(1.05).shift(band_shift(10) + DOWN * 0.9)
        ...
        self.wait(2.5)
        b11_l2 = MathTex(r"\text{Quiet month: } \text{R}34{,}50 \text{ vs } \text{R}55 \Rightarrow \text{pay-as-you-go}").scale(0.95).shift(band_shift(11) + UP * 0.1)
        b11_l3 = MathTex(r"\text{Busy month: } \text{R}150{,}50 \text{ vs } \text{R}55 \Rightarrow \text{bundle}").scale(0.95).shift(band_shift(11) + DOWN * 0.9)
