...
class MeasurementMapsDataEssentialsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b1_l3 = MathTex(r"1 \text{ m}^3 = 1\;000 \text{ litres} \Rightarrow 3\;600 \text{ litres}").scale(1.05).shift(band_shift(1) + DOWN * 0.8)
        ...
        self.wait(2.5)
        b2_l3 = MathTex(r"4\;500 \text{ mm} = 4{,}5 \text{ m} \quad 3{,}2 \text{ km} = 3\;200 \text{ m}").scale(1.0).shift(band_shift(2) + DOWN * 0.8)
