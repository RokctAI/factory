...
class FinanceCalculationEssentialsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0_l2 = MathTex(r"\frac{\text{change}}{\text{original}} \times 100 = \frac{3}{15} \times 100 = 20\%").scale(1.05).shift(DOWN * 1.2)
        ...
        self.wait(2)
        b3_l3 = MathTex(r"\text{R2 000 at } 8\%: \; 0{,}08 \times 2\;000 = \text{R}160 \text{ per year}").scale(1.0).shift(band_shift(3) + DOWN * 0.8)
        ...
        b4_l2 = MathTex(r"\text{Expenses: } 2\;500 + 1\;200 + 900 + 650 + 800 = \text{R}6\;050").scale(0.9).shift(band_shift(4) + UP * 0.2)
