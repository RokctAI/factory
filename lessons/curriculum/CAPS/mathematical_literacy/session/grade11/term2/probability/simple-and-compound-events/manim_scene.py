...
class SimpleAndCompoundEventsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        b3_l3 = MathTex(r"\text{200 tosses, 92 heads: theory } 0{,}5, \text{ watched } \tfrac{92}{200} = 0{,}46").scale(0.78).shift(band_shift(3) + DOWN * 0.9)
        ...
        self.wait(2.5)
        b4_l1 = MathTex(r"P(2\text{ heads}) = \tfrac{1}{4}; \;\; P(\text{exactly one}) = \tfrac{2}{4} = \tfrac{1}{2}").scale(0.79).shift(band_shift(4) + DOWN * 2.1)
        ...
        self.wait(1.5)
        b7_l1 = MathTex(r"P(\text{learner}) = \tfrac{70}{120} = \tfrac{7}{12} \approx 0{,}58").scale(1.03).shift(band_shift(7) + UP * 1.1)
        ...
        self.wait(2.5)
        b10_l1 = Tex(r"Multiply along the path: $\tfrac{1}{2} \times \tfrac{1}{2} = \tfrac{1}{4}$ each route").scale(0.87).shift(band_shift(10) + UP * 1.2)
        ...
        b10_l3 = MathTex(r"\text{Grid: } P(\text{learner}) = \tfrac{70}{120}; \;\; \text{given a learner: } \tfrac{28}{70}").scale(0.73).shift(band_shift(10) + DOWN * 0.8)
