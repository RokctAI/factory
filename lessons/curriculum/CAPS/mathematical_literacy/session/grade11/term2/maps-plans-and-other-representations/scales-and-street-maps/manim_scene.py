...
class ScalesAndStreetMapsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        l1 = MathTex(r"1 : 50\,000 \;\; \text{— 1 cm on paper} = 50\,000\text{ cm real}").scale(1.0).shift(UP * 1.1)
        ...
        l4 = MathTex(r"\div 100 = 3\,500\text{ m}; \quad \div 1\,000 = 3{,}5\text{ km}").scale(1.05).shift(DOWN * 1.7)
        ...
        b7_l2 = MathTex(r"7\text{ cm} \to 350\,000\text{ cm} \to 3\,500\text{ m} \to 3{,}5\text{ km}").scale(1.0).shift(band_shift(7) + UP * 0.2)
