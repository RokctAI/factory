...
class ProfitBreakEvenInterestInflationSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2.5)
        b4_l4 = MathTex(r"\text{Simple: } 3 \times 420 \to R7\,260; \;\; \text{compound wins by } R90{,}26").scale(0.9).shift(band_shift(4) + DOWN * 1.7)
        ...
        self.wait(1.5)
        b6_l1 = MathTex(r"1\,850 \times 1{,}06 = R1\,961 \quad \text{(R111 short if unbudgeted)}").scale(0.95).shift(band_shift(6) + UP * 1.1)
        self.play(Write(b6_l1))
        self.play(Create(SurroundingRectangle(b6_l1, color=GREEN)))
        self.wait(2.5)
        b6_wrong = MathTex(r"1{,}55 \div 17{,}05 = 9{,}1\% \quad \text{(divided by the NEW price!)}").scale(0.95).shift(band_shift(6) + UP * 0.1)
        ...
        b9_l2 = MathTex(r"300 \div 3{,}40 = 88{,}2 \;\Rightarrow\; \text{number } 89 \text{ breaks even}").scale(1.0).shift(band_shift(9) + UP * 0.2)
