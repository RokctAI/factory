...
class RelationshipsTablesFormulaeSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(1.5)
        b7_wrong = MathTex(r"790 \div 21{,}50 = 36{,}7 \quad \text{(basic charge not removed!)}").scale(0.95).shift(band_shift(7) + UP * 1.1)
        ...
        b8_l2 = MathTex(r"630; \;\; 910; \;\; 1\,190; \;\; 1\,470 \quad \text{(+280 each step)}").scale(1.0).shift(band_shift(8) + UP * 0.2)
