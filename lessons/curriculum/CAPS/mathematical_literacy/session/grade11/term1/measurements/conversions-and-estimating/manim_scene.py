...
class ConversionsAndEstimatingSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        l1 = MathTex(r"1\text{ km} = 1\,000\text{ m}, \quad 1\text{ m} = 1\,000\text{ mm}").scale(1.1).shift(UP * 1.1)
        l2 = MathTex(r"1\text{ kg} = 1\,000\text{ g}, \quad 1\ \ell = 1\,000\text{ m}\ell").scale(1.1).shift(UP * 0.2)
        ...
        self.wait(1.5)
        b3_l1 = MathTex(r"6\text{ ft} = 6 \times 30{,}48 = 182{,}88\text{ cm} \approx 1{,}83\text{ m}").scale(1.0).shift(band_shift(3) + UP * 1.1)
        ...
        self.wait(1.5)
        b8_l1 = MathTex(r"7{,}5 \times 3 \times 5 = 112{,}5\text{ m}\ell \Rightarrow \text{two }100\text{ m}\ell\text{ bottles}").scale(0.95).shift(band_shift(8) + UP * 1.1)
        b8_l2 = Tex(r"Teaspoon $\approx 5$ m$\ell$, so 7,5 m$\ell$ $=$ 1$\tfrac{1}{2}$ teaspoons").scale(1.0).shift(band_shift(8) + UP * 0.2)
        ...
        b10_l4 = MathTex(r"\text{Cement: } 50 \times 2{,}2 = 110\text{ lb}; \quad 33 \div 2{,}2 = 15\text{ kg}").scale(0.95).shift(band_shift(10) + DOWN * 1.7)
        ...
        self.wait(2.5)
        b11_l1 = MathTex(r"20 \div 5 = 4\text{ m}^2\text{ per litre}; \quad 108 \div 4 = 27\ \ell").scale(1.0).shift(band_shift(11) + UP * 1.2)
        ...
        self.wait(3)
        b11_l3 = MathTex(r"\text{Medicine: } 7{,}5 \times 3 \times 5 = 112{,}5\text{ m}\ell \Rightarrow \text{2 bottles}").scale(0.95).shift(band_shift(11) + DOWN * 0.8)
        self.play(Write(b11_l3)); self.wait(3)
        b11_l4 = MathTex(r"\text{Feed 30 from 4: } \times 7{,}5; \quad 3\text{ eggs} \to 23\text{ eggs}").scale(0.95).shift(band_shift(11) + DOWN * 1.8)
