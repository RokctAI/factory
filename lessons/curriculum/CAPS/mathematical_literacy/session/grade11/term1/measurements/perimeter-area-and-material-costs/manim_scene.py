...
class PerimeterAreaCostsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(1.5)
        b5_l1 = MathTex(r"\text{Door: } 0{,}9 \times 2{,}0 = 1{,}8\text{ m}^2; \;\; \text{window: } 1{,}5 \times 1{,}2 = 1{,}8\text{ m}^2").scale(0.9).shift(band_shift(5) + UP * 1.1)
        ...
        self.wait(1.5)
        b8_l1 = MathTex(r"92{,}93 \times 1{,}10 = 102{,}22 \Rightarrow \text{order } 103\text{ m}^2").scale(1.0).shift(band_shift(8) + UP * 1.1)
        ...
        b9_l3 = MathTex(r"\text{Fence} = 41 - 3 = 38\text{ m}; \quad 38 \times 289 = R10\,982").scale(1.0).shift(band_shift(9) + DOWN * 0.8)
        ...
        self.wait(2.5)
        b11_l1 = MathTex(r"8{,}85\ \ell \Rightarrow \text{two } 5\ \ell \text{ tins} = R1\,050").scale(1.05).shift(band_shift(11) + UP * 1.2)
