...
class Paper2PracticeRunSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0_l1 = MathTex(r"\text{Measurement } 55\%; \text{ Maps and Plans } 40\%; \text{ Prob } 5\%").scale(0.95).shift(UP * 1.2)
        ...
        self.wait(2.5)
        b3_l3 = MathTex(r"\text{Strip map: } 9 \times 50\;000 = 450\;000 \text{ cm} = 4{,}5 \text{ km}").scale(0.95).shift(band_shift(3) + DOWN * 0.9)
