...
class PlansElevationsPackagingSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0_l1 = MathTex(r"\text{Scale } 1:100: \; 1 \text{ mm paper} = 100 \text{ mm real}").scale(1.0).shift(UP * 1.2)
        ...
        self.wait(2.5)
        b1_l4 = MathTex(r"\text{Reverse: 2 m cupboard} = 2\;000 \div 100 = 20 \text{ mm}").scale(1.0).shift(band_shift(1) + DOWN * 1.8)
        ...
        self.wait(2)
        b4_l4 = MathTex(r"\text{8 bolts, packs of 6: } 8 \div 6 = 1{,}33 \Rightarrow 2 \text{ packs}").scale(1.0).shift(band_shift(4) + DOWN * 1.4)
        ...
        b6_l2 = MathTex(r"30 \div 6 = 5; \quad 24 \div 4 = 6; \quad 5 \times 6 = 30 \text{ per layer}").scale(0.95).shift(band_shift(6) + UP * 0.3)
        b6_l3 = MathTex(r"20 \div 10 = 2 \text{ layers}; \quad 30 \times 2 = 60 \text{ boxes}").scale(1.05).shift(band_shift(6) + DOWN * 0.7)
        ...
        self.wait(2.5)
        b7_l3 = MathTex(r"\text{Model at } 1:50: \; 10 \text{ m} \rightarrow 20 \text{ cm}, \; 6 \text{ m} \rightarrow 12 \text{ cm}").scale(0.95).shift(band_shift(7) + DOWN * 0.8)
        b7_l4 = MathTex(r"\text{Areas scale by the SQUARE: } \tfrac{1}{50^2} = \tfrac{1}{2\;500}").scale(1.0).shift(band_shift(7) + DOWN * 1.8)
        ...
        b8_l2 = MathTex(r"165 \div 12 = 13{,}75 \;\Rightarrow\; \text{buy } 14 \text{ boxes}").scale(1.05).shift(band_shift(8) + UP * 0.3)
        ...
        self.wait(2.5)
        b10_l4 = MathTex(r"\text{Glass: } 1{,}6 \text{ m wide} \times 1{,}5 \text{ m tall} = 2{,}4 \text{ m}^2").scale(1.0).shift(band_shift(10) + DOWN * 1.5)
