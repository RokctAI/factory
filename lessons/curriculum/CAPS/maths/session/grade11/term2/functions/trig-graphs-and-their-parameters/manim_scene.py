...
class TrigGraphsParametersSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(1.5)
        w1 = MathTex(r"y = \sin x: \; 0, 1, 0, -1, 0 \text{ at } 0^\circ, 90^\circ, 180^\circ, 270^\circ, 360^\circ").scale(0.85).shift(UP * 0.9)
        self.play(Write(w1))
        self.wait(2.5)
        ...
        self.wait(1.5)
        b1_l1 = MathTex(r"\tan 0^\circ = 0, \quad \tan 45^\circ = 1, \quad \tan 90^\circ \text{ explodes}").scale(0.95).shift(band_shift(1) + UP * 1.1)
        b1_l2 = Tex(r"Vertical asymptotes at $90^\circ + k \times 180^\circ$").scale(1.0).shift(band_shift(1) + UP * 0.2)
        self.play(Write(b1_l1))
        self.wait(2.5)
        self.play(Write(b1_l2))
        self.wait(2.5)
        b1_l3 = MathTex(r"\text{Period } 180^\circ; \text{ no amplitude — every value taken}").scale(0.95).shift(band_shift(1) + DOWN * 0.8)
        ...
        self.wait(2.5)
        b2_l3 = MathTex(r"\text{Max } 3 \text{ at } 90^\circ, \quad \text{min } -1 \text{ at } 270^\circ").scale(1.0).shift(band_shift(2) + DOWN * 0.8)
        ...
        self.wait(2)
        b4_l1 = MathTex(r"\cos 2x: \; \frac{360^\circ}{2} = 180^\circ \;\text{— two waves fit}").scale(1.0).shift(band_shift(4) + UP * 1.1)
        b4_l2 = MathTex(r"\sin \tfrac{1}{2}x: \; \frac{360^\circ}{1/2} = 720^\circ \;\text{— a lazy half-wave}").scale(0.95).shift(band_shift(4) + UP * 0.1)
        b4_l3 = MathTex(r"\tan 2x: \; \frac{180^\circ}{2} = 90^\circ, \text{ walls at } 45^\circ + k \times 90^\circ").scale(0.95).shift(band_shift(4) + DOWN * 0.9)
        ...
        self.wait(2)
        b5_l1 = MathTex(r"\text{Max } 0^\circ, \; \text{zero } 45^\circ, \; \text{min } 90^\circ").scale(1.05).shift(band_shift(5) + UP * 1.0)
        ...
        self.wait(3)
        b6_l3 = MathTex(r"\text{Anchors: climb } 30^\circ, \text{ max } 120^\circ, \text{ zero } 210^\circ, \text{ min } 300^\circ").scale(0.9).shift(band_shift(6) + DOWN * 0.6)
        ...
        b7_l2 = MathTex(r"2. \text{ Shift } 60^\circ \text{ right: max } 60^\circ, \text{ zero } 150^\circ, \text{ min } 240^\circ").scale(0.9).shift(band_shift(7) + UP * 0.3)
        ...
        self.wait(2.5)
        b9_l4 = Tex(r"Count waves in the window: two waves $\Rightarrow k = 2$").scale(1.0).shift(band_shift(9) + DOWN * 1.6)
