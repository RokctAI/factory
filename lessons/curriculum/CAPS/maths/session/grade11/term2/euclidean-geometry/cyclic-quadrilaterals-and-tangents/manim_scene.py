...
class CyclicQuadrilateralsTangentsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(d1))
        self.wait(2)
        d2 = MathTex(r"\hat{B} + \hat{D} = 180^\circ, \quad \hat{A} + \hat{C} = 180^\circ").scale(1.1).shift(UP * 0.1)
        self.play(Write(d2))
        ...
        d4 = MathTex(r"2\hat{B} + 2\hat{D} = 360^\circ \;\Rightarrow\; \hat{B} + \hat{D} = 180^\circ").scale(1.0).shift(DOWN * 1.9)
        self.play(Write(d3))
        self.wait(2.5)
        self.play(Write(d4))
        self.wait(2.5)
        ...
        self.wait(1.5)
        b1_l1 = MathTex(r"\hat{A} = 95^\circ \;\Rightarrow\; \hat{C} = 180^\circ - 95^\circ = 85^\circ").scale(1.05).shift(band_shift(1) + UP * 1.1)
        ...
        self.wait(1.5)
        b5_l1 = MathTex(r"\text{In } \triangle OAP, \triangle OBP: \; OA = OB \;\text{(radii)}, \; OP \text{ common}").scale(0.9).shift(band_shift(5) + UP * 1.1)
        b5_l2 = MathTex(r"\hat{A} = \hat{B} = 90^\circ \;\text{(tangent} \perp \text{radius)}").scale(0.95).shift(band_shift(5) + UP * 0.2)
        b5_l3 = MathTex(r"\text{RHS} \;\Rightarrow\; PA = PB \;\text{(tangents from same point)}").scale(0.95).shift(band_shift(5) + DOWN * 0.7)
        ...
        self.wait(2.5)
        b5_l4 = MathTex(r"\hat{P} = 40^\circ: \;\; \hat{PAB} = \hat{PBA} = \frac{180^\circ - 40^\circ}{2} = 70^\circ").scale(0.95).shift(band_shift(5) + DOWN * 1.8)
        ...
        b6_l3 = MathTex(r"\hat{BAC} = 90^\circ - x, \quad \hat{ABC} = 90^\circ \;\text{(semicircle)}").scale(0.95).shift(band_shift(6) + DOWN * 0.7)
        ...
        self.wait(2)
        b6_l5 = MathTex(r"\text{Tangent-chord } 65^\circ \Rightarrow 65^\circ \text{ on the far arc}").scale(0.95).shift(band_shift(6) + DOWN * 2.6)
        ...
        b7_l2 = MathTex(r"\hat{PAB} = \hat{PBA} = 70^\circ \;\text{(isosceles, sum } 180^\circ)").scale(0.95).shift(band_shift(7) + UP * 0.3)
        ...
        self.wait(2.5)
        b7_l4 = MathTex(r"\text{Check: } \hat{AOB} = 360^\circ - 90^\circ - 90^\circ - 40^\circ = 140^\circ").scale(0.9).shift(band_shift(7) + DOWN * 1.7)
        b7_l5 = MathTex(r"\hat{ACB} = 140^\circ \div 2 = 70^\circ \;\text{ — same answer, second road}").scale(0.9).shift(band_shift(7) + DOWN * 2.6)
        ...
        self.wait(2.5)
        b8_l3 = MathTex(r"2\hat{B} + 2\hat{D} = 360^\circ \;\Rightarrow\; \hat{B} + \hat{D} = 180^\circ").scale(1.05).shift(band_shift(8) + DOWN * 0.8)
        ...
        b9_l5 = MathTex(r"\text{Peg angle } 40^\circ: \text{ base angles } 70^\circ \text{ each}").scale(1.0).shift(band_shift(9) + DOWN * 2.7)
