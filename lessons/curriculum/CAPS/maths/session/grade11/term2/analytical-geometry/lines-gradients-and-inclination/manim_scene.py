...
class LinesGradientsInclinationSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        b3_l3 = MathTex(r"m_{AB} = m_{BC}, \text{ shared point } B \;\Rightarrow\; \text{collinear}").scale(1.0).shift(band_shift(3) + DOWN * 1.1)
        ...
        b5_l4 = MathTex(r"-1 = -\tfrac{1}{2}(2) + c \;\Rightarrow\; c = 0: \quad y = -\tfrac{1}{2}x").scale(1.0).shift(band_shift(5) + DOWN * 1.7)
        ...
        self.wait(1.5)
        b6_l1 = MathTex(r"m = \tan\theta, \quad 0^\circ \leq \theta < 180^\circ").scale(1.1).shift(band_shift(6) + UP * 1.1)
        ...
        self.wait(2)
        b6_l3 = MathTex(r"m = 1: \; \theta = 45^\circ \qquad m = 2: \; \theta = 63{,}43^\circ").scale(1.0).shift(band_shift(6) + DOWN * 0.8)
        ...
        self.wait(1.5)
        b7_wrong = MathTex(r"\tan^{-1}\left(-\tfrac{4}{3}\right) = -53{,}13^\circ \;\text{(not an inclination)}").scale(0.95).shift(band_shift(7) + UP * 1.2)
        ...
        self.wait(2)
        b7_l5 = Tex(r"Horizontal: $\theta = 0^\circ$; vertical: $\theta = 90^\circ$, $\tan$ undefined").scale(0.9).shift(band_shift(7) + DOWN * 3.0)
