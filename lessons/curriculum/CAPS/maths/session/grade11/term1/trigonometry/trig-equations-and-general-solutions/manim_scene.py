...
class TrigEquationsGeneralSolutionsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(d1))
        self.wait(2)
        d2 = MathTex(r"\sin(180^\circ - 30^\circ) = \sin 30^\circ \;\Rightarrow\; x = 150^\circ \text{ too}").scale(1.0).shift(DOWN * 0.1)
        self.play(Write(d2))
        self.wait(2.5)
        d3 = MathTex(r"\text{Full turns repeat it: } 390^\circ, \; -330^\circ, \; \dots").scale(1.05).shift(DOWN * 1.1)
        self.play(Write(d3))
        self.wait(2)
        d4 = Tex("Infinitely many answers — no list can hold them").scale(1.05).shift(DOWN * 2.1)
        self.play(Write(d4))
        self.wait(2.5)
        ...
        b2_l2 = MathTex(r"x = \alpha + k \times 360^\circ \;\text{ or }\; x = 180^\circ - \alpha + k \times 360^\circ").scale(0.95).shift(band_shift(2) + UP * 0.2)
        ...
        b3_l3 = MathTex(r"x = \pm 60^\circ + k \times 360^\circ, \quad k \in \mathbb{Z}").scale(1.1).shift(band_shift(3) + DOWN * 0.8)
        ...
        self.wait(2)
        b3_l4 = MathTex(r"\text{Test: } 60^\circ, \; -60^\circ \,(= 300^\circ), \; 420^\circ \text{ all work}").scale(1.0).shift(band_shift(3) + DOWN * 1.8)
        ...
        self.wait(2)
        b4_l5 = MathTex(r"x = 216{,}87^\circ + k360^\circ \text{ or } x = 323{,}13^\circ + k360^\circ").scale(0.95).shift(band_shift(4) + DOWN * 3.0)
        ...
        b5_l4 = MathTex(r"\text{Tan negative in Q2: } 180^\circ - 68{,}2^\circ = 111{,}8^\circ").scale(1.0).shift(band_shift(5) + DOWN * 1.7)
        ...
        self.wait(2)
        b7_l1 = MathTex(r"x = 30^\circ + k360^\circ \;\text{ or }\; x = 150^\circ + k360^\circ").scale(1.0).shift(band_shift(7) + UP * 1.1)
        self.play(Write(b7_l1))
        self.wait(2.5)
        b7_l2 = MathTex(r"k = 0: 30^\circ \checkmark \quad k = 1: 390^\circ \times \quad k = -1: -330^\circ \checkmark").scale(0.9).shift(band_shift(7) + UP * 0.2)
        b7_l3 = MathTex(r"k = 0: 150^\circ \checkmark \quad k = -1: -210^\circ \checkmark").scale(0.95).shift(band_shift(7) + DOWN * 0.7)
        ...
        b8_l2 = MathTex(r"(2s + 1)(s - 1) = 0 \;\Rightarrow\; s = -\tfrac{1}{2} \text{ or } s = 1").scale(1.0).shift(band_shift(8) + UP * 0.2)
        ...
        b10_l2 = MathTex(r"30^\circ \text{ up}, \quad 180^\circ - 30^\circ = 150^\circ \text{ down}").scale(1.0).shift(band_shift(10) + UP * 0.2)
        ...
        b10_l5 = Tex(r"Peak $\sin x = 1$: the doors merge — $90^\circ + k360^\circ$ only").scale(0.95).shift(band_shift(10) + DOWN * 2.7)
        ...
        self.wait(2)
        b11_l1 = Tex(r"Permit $[-360^\circ; 360^\circ]$: run $k$, keep what lands inside").scale(0.95).shift(band_shift(11) + UP * 1.1)
