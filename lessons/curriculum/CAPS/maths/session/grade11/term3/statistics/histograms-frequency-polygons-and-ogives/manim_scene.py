...
class HistogramsPolygonsOgivesSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b8_l4 = MathTex(r"\text{everyone mid-building: } \bar{x} \approx \tfrac{910}{40} = 22{,}75").scale(1.0).shift(band_shift(8) + DOWN * 1.6)
        ...
        self.wait(2.5)
        b10_l2 = MathTex(r"Q_1 \approx 14, \quad Q_3 \approx 30, \quad IQR \approx 16").scale(1.05).shift(band_shift(10) + UP * 0.2)
        self.play(Write(b10_l2))
        self.wait(2.5)
        b10_l3 = MathTex(r"P_{90} \text{ (position } 36\text{)} \approx 39 \text{ min}").scale(1.05).shift(band_shift(10) + DOWN * 0.7)
        self.play(Write(b10_l3))
        self.wait(2)
        b10_l4 = MathTex(r"\text{Over } 35 \text{ min: } 40 - 34 \approx 6 \text{ learners}").scale(1.05).shift(band_shift(10) + DOWN * 1.6)
