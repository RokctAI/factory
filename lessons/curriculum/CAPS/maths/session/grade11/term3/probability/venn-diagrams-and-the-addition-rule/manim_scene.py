...
class VennDiagramsAdditionRuleSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0_l2 = Tex("Theoretical model — needs EQUALLY LIKELY outcomes").scale(1.05).shift(UP * 0.1)
        ...
        self.wait(1.5)
        b4_l1 = MathTex(r"P(A \text{ and } B) = 0 \;\Rightarrow\; P(A \text{ or } B) = P(A) + P(B)").scale(1.0).shift(band_shift(4) + UP * 1.1)
        ...
        self.wait(2.5)
        b5_l3 = Tex(r"``Multiple of 4'' and ``odd'': exclusive, but $\tfrac{2}{3} \neq 1$").scale(1.0).shift(band_shift(5) + DOWN * 0.9)
        ...
        self.wait(1.5)
        b7_l1 = MathTex(r"P(M) \times P(G) = \tfrac{70}{120} \times \tfrac{50}{120} \approx 0{,}243").scale(1.05).shift(band_shift(7) + UP * 1.1)
