...
class DecayNominalEffectiveSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b2_l1 = MathTex(r"\text{Convert first: } i = \frac{0{,}09}{12} = 0{,}0075, \quad n = 24").scale(1.0).shift(band_shift(2) + UP * 1.1)
        ...
        b4_l2 = MathTex(r"\text{B: } \left(1 + \frac{0{,}093}{4}\right)^4 = 1{,}02325^4 = 1{,}09629").scale(0.95).shift(band_shift(4) + UP * 0.1)
        ...
        b6_l5 = Tex("output becomes segment two's P — multiply factors through").scale(0.95).shift(band_shift(6) + DOWN * 2.7)
        ...
        b7_l2 = MathTex(r"4 \times 36\,000 = 144\,000 \text{ gone} \;\Rightarrow\; \text{R}96\,000 \text{ left}").scale(0.95).shift(band_shift(7) + UP * 0.2)
        ...
        self.wait(2.5)
        b7_l5 = Tex("A photocopy never becomes a blank page — underline the keyword").scale(0.85).shift(band_shift(7) + DOWN * 2.6)
        ...
        self.wait(2.5)
        b8_l3 = MathTex(r"\text{R}11\,964 \text{ vs } \text{R}11\,881 \;\text{— R83 of payday timing}").scale(0.95).shift(band_shift(8) + DOWN * 0.8)
        ...
        b9_l4 = MathTex(r"\text{A: } 9{,}4\% \quad \text{vs} \quad \text{B: } 9{,}63\% \;\text{— B wins}").scale(1.0).shift(band_shift(9) + DOWN * 1.7)
