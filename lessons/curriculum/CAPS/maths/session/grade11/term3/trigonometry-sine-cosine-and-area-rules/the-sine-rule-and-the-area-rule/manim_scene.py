...
class SineRuleAreaRuleSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b3_l3 = MathTex(r"a = \frac{12\sin 40^\circ}{\sin 65^\circ} = \frac{7{,}7135}{0{,}9063}").scale(1.05).shift(band_shift(3) + DOWN * 1.1)
        ...
        self.wait(2.5)
        b4_l2 = MathTex(r"B = 27{,}9^\circ \quad \text{then} \quad C = 110{,}1^\circ").scale(1.1).shift(band_shift(4) + UP * 0.0)
        ...
        self.wait(2.5)
        b4_l4 = MathTex(r"152{,}07^\circ + 42^\circ > 180^\circ \;\Rightarrow\; \text{rejected}").scale(1.0).shift(band_shift(4) + DOWN * 2.1)
        ...
        self.wait(2.5)
        b7_l3 = MathTex(r"90^\circ: \sin = 1 \text{, max area.}\;\; 0^\circ \text{ or } 180^\circ: \text{flat}").scale(0.95).shift(band_shift(7) + DOWN * 0.9)
        ...
        self.wait(2)
        b9_l3 = MathTex(r"180^\circ \text{ gave } 65^\circ \to \text{sine rule gave } 13{,}04").scale(1.0).shift(band_shift(9) + DOWN * 0.7)
