...
class CosineRule2DProblemsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b5_l3 = MathTex(r"\cos\theta = \tfrac{25 + 49 - 100}{2(5)(7)} = \tfrac{-26}{70} = -0{,}3714").scale(1.0).shift(band_shift(5) + DOWN * 1.0)
        ...
        self.wait(2.5)
        b7_l3 = MathTex(r"\hat{Q} \approx 180^\circ - 70^\circ - 71^\circ \approx 39^\circ").scale(1.0).shift(band_shift(7) + DOWN * 1.1)
