...
# 2-methylbutane skeleton is hand-built from Tex atoms and Line bonds
...
class FunctionalGroupsIupacNamingSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b0_l1 = Tex("Carbon: exactly FOUR bonds, always").scale(1.05).shift(UP * 1.2)
        ...
        b0_l4 = Tex("determines the properties of a family").scale(1.0).shift(DOWN * 1.3)
        ...
        self.wait(2)
        b0_l5 = Tex(r"Homologous series: same general formula,").scale(1.0).shift(DOWN * 2.2)
        b0_l6 = Tex(r"members differ by one $CH_2$ unit").scale(1.0).shift(DOWN * 2.9)
        ...
        self.wait(2)
        b1_l3 = MathTex(r"\text{Molecular: } C_4H_{10} \text{ — just counts}").scale(1.0).shift(band_shift(1) + UP * 0.3)
        b1_l4 = MathTex(r"\text{Condensed: } CH_3CH_2CH_2CH_3").scale(1.0).shift(band_shift(1) + DOWN * 0.6)
        b1_l5 = Tex("Structural: EVERY atom and bond drawn").scale(1.0).shift(band_shift(1) + DOWN * 1.5)
        ...
        self.wait(2)
        b1_l6 = Tex("Asked 'structural', drawn condensed: no mark").scale(0.95).shift(band_shift(1) + DOWN * 2.5)
        ...
        self.wait(2)
        b2_l4 = Tex("Alcohols: --OH, suffix -anol").scale(1.0).shift(band_shift(2) + DOWN * 1.6)
        ...
        self.wait(2)
        b3_l1 = Tex("Aldehyde: C=O at the END, -al (propanal)").scale(0.95).shift(band_shift(3) + UP * 1.2)
        b3_l2 = Tex("Ketone: C=O INSIDE, -one (propanone)").scale(0.95).shift(band_shift(3) + UP * 0.3)
        self.play(Write(b3_l1))
        self.wait(2)
        self.play(Write(b3_l2))
        self.wait(2)
        b3_l3 = Tex("Carboxylic acid: --COOH, -anoic acid").scale(0.95).shift(band_shift(3) + DOWN * 0.6)
        b3_l4 = Tex("Ester: chain--COO--chain (ethyl ethanoate)").scale(0.95).shift(band_shift(3) + DOWN * 1.5)
        self.play(Write(b3_l3))
        self.wait(2)
        self.play(Write(b3_l4))
        self.wait(2)
        b3_l5 = Tex("First question, always: which group is present?").scale(0.95).shift(band_shift(3) + DOWN * 2.5)
        self.play(Write(b3_l5))
        self.play(Create(SurroundingRectangle(b3_l5, color=GREEN)))
        self.wait(3)

        # --- Band 4 (subtopic_3): the four steps, and 2-methylbutane ---
        self.next_band(4)
        ...
        b4_l3 = Tex("3. Substituents + positions").scale(0.95).shift(band_shift(4) + DOWN * 0.2)
        ...
        self.wait(2)
        b4_l5 = Tex("Four-carbon chain, methyl on carbon 2:").scale(1.0).shift(band_shift(4) + DOWN * 1.8)
        b4_l6 = Tex("2-methylbutane (never 3- from the far end)").scale(1.0).shift(band_shift(4) + DOWN * 2.6)
        ...
        self.next_band(5)
        b5_l1 = Tex("OH on the middle of three: propan-2-ol").scale(1.0).shift(band_shift(5) + UP * 2.2)
        b5_l2 = Tex("(on the end: propan-1-ol — different!)").scale(0.95).shift(band_shift(5) + UP * 1.4)
        self.play(Write(b5_l1))
        self.wait(2)
        self.play(Write(b5_l2))
        self.wait(2)
        b5_l3 = Tex("Double bond outranks the branch:").scale(1.0).shift(band_shift(5) + UP * 0.4)
        b5_l4 = Tex("3-methylbut-1-ene").scale(1.1).shift(band_shift(5) + DOWN * 0.4)
        self.play(Write(b5_l3))
        self.wait(1.5)
        self.play(Write(b5_l4))
        self.wait(2)
        b5_l5 = Tex("Two chlorines: 1,2-dichloroethane").scale(1.0).shift(band_shift(5) + DOWN * 1.3)
        self.play(Write(b5_l5))
        self.wait(2)
        b5_l6 = Tex("Reverse: 2-bromobutane — four carbons,").scale(0.95).shift(band_shift(5) + DOWN * 2.2)
        b5_l7 = Tex("Br on carbon 2, then audit four bonds each").scale(0.95).shift(band_shift(5) + DOWN * 2.9)
        ...
        self.wait(2)
        b6_l1 = MathTex(r"\text{Chain: } C_4H_{10} = \text{butane or 2-methylpropane}").scale(0.9).shift(band_shift(6) + UP * 1.2)
        self.play(Write(b6_l1))
        self.wait(2)
        b6_l2 = Tex("Positional: butan-1-ol vs butan-2-ol").scale(0.95).shift(band_shift(6) + UP * 0.3)
        self.play(Write(b6_l2))
        self.wait(2)
        b6_l3 = MathTex(r"\text{Functional: propanal / propanone } (C_3H_6O)").scale(0.9).shift(band_shift(6) + DOWN * 0.6)
        self.play(Write(b6_l3))
        self.wait(2)
        b6_wrong = Tex("A bent drawing of pentane = an isomer?").scale(0.95).shift(band_shift(6) + DOWN * 1.6)
        ...
        self.wait(2)
        b7_l2 = Tex("Middle = chain length: meth 1, eth 2,").scale(0.95).shift(band_shift(7) + UP * 0.3)
        ...
        b7_l5 = Tex("group gets the LOWEST one available").scale(0.95).shift(band_shift(7) + DOWN * 2.0)
        ...
        # --- Band 8 (subtopic_6): four hands — build 2-methylbutane ---
        self.next_band(8)
        b8_t = Tex("Carbon has four hands: build 2-methylbutane").scale(1.0).shift(band_shift(8) + UP * 2.6)
        self.play(Write(b8_t))
        self.wait(2)
        # skeleton: four Tex C atoms joined by Line bonds, methyl branch on C2
        base = band_shift(8) + LEFT * 3.0 + UP * 0.6
        ...
        self.wait(2)
        b8_l1 = Tex("Pass 3: top up every spare hand with H").scale(0.95).shift(band_shift(8) + DOWN * 0.9)
        self.play(Write(b8_l1))
        self.wait(2)
        b8_l2 = MathTex(r"C_5H_{12}, \text{ four bonds per C} \; \checkmark").scale(1.0).shift(band_shift(8) + DOWN * 1.8)
        self.play(Write(b8_l2))
        self.play(Create(SurroundingRectangle(b8_l2, color=GREEN)))
        self.wait(2)
        b8_l3 = Tex("A carbon with five bonds = a found mistake").scale(0.95).shift(band_shift(8) + DOWN * 2.8)
        ...
        self.wait(2)
        b9_l1 = Tex("Same bricks, different building:").scale(1.0).shift(band_shift(9) + UP * 1.2)
        b9_l2 = MathTex(r"C_4H_{10}: \text{ butane or 2-methylpropane}").scale(0.95).shift(band_shift(9) + UP * 0.3)
        self.play(Write(b9_l1))
        self.wait(1.5)
        self.play(Write(b9_l2))
        self.wait(2)
        b9_l3 = Tex("Three twin types: re-route the skeleton,").scale(0.95).shift(band_shift(9) + DOWN * 0.6)
        ...
        b9_l6 = Tex("only changed bonds make a new molecule").scale(1.0).shift(band_shift(9) + DOWN * 2.9)
