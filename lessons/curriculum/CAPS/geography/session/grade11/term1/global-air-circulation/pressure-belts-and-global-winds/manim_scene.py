...
class PressureBeltsGlobalWindsSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.wait(2)
        b7_l1 = Tex(r"DALR: $1\,^\circ$C per 100 m of descent").scale(1.0).shift(band_shift(7) + DOWN * 1.7 + LEFT * 2.4)
        self.play(Write(b7_l1))
        self.wait(2)
        b7_l2 = MathTex(r"1\,800 \div 100 \times 1 = 18\,^\circ\text{C}").scale(1.05).shift(band_shift(7) + DOWN * 2.4 + LEFT * 2.4)
