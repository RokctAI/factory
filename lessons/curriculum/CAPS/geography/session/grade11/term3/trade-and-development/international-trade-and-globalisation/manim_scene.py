...
class InternationalTradeGlobalisationSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        b1_in_lab = Tex(r"machinery, electronics,\\ petroleum, medicines").scale(0.9).shift(band_shift(1) + UP * 1.9 + LEFT * 3.4)
        ...
        self.wait(1.5)
        b2_l1 = MathTex(r"\text{Terms of trade} = \frac{\text{export prices}}{\text{import prices}}").scale(1.1).shift(band_shift(2) + UP * 0.9)
        ...
        self.wait(2)
        b4_l2 = Tex(r"Drivers: containers, instant comms,\\ lower trade barriers").scale(1.05).shift(band_shift(4) + UP * 0.2)
        ...
        self.wait(2)
        b6_l3 = Tex(r"1960: Korea $\approx$ Ghana; now developed").scale(1.0).shift(band_shift(6) + UP * 0.6 + LEFT * 2.6)
        ...
        self.wait(2)
        b10_l1 = Tex(r"T-shirts $\Rightarrow$ steel $\Rightarrow$ ships $\Rightarrow$ cars $\Rightarrow$ chips").scale(1.05).shift(band_shift(10) + UP * 1.2)
        ...
        self.wait(2.5)
        b10_l5 = Tex(r"SA climbs with a heavy backpack:\\ load-shedding, distance, skills gap").scale(1.0).shift(band_shift(10) + DOWN * 2.2)
