...
# to subtopics.json (220/250/250/260/160/160/160 of 1460 s).
...
class SumAndDifferenceOfCubesSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(Write(l02))
        self.wait(2)
        l03 = MathTex(r"y^9 = (y^3)^3, \quad 27a^3b^3 = (3ab)^3").scale(1.05).shift(DOWN * 1.0)
        self.play(Write(l03))
        self.wait(2)
        ...
        self.wait(2)
        b1_l4 = Tex(r"Long bracket: square, multiply, square").scale(1.05).shift(band_shift(1) + DOWN * 2.0)
        ...
        self.wait(2)
        b2_l3 = Tex(r"$-a^2b$ meets $+a^2b$; $+ab^2$ meets $-ab^2$").scale(1.0).shift(band_shift(2) + DOWN * 0.9)
        b2_l4 = MathTex(r"\text{Left standing: } a^3 + b^3").scale(1.15).shift(band_shift(2) + DOWN * 1.9)
        ...
        self.next_band(4)
        b4_title = Tex("Verify — then stop in the right place").scale(1.15).shift(band_shift(4) + UP * 2.2)
        ...
        self.next_band(5)
        b5_title = Tex(r"The twin: $x^3 - 64$").scale(1.2).shift(band_shift(5) + UP * 2.2)
        self.play(Write(b5_title))
        self.wait(1.5)
        b5_l1 = MathTex(r"a = x, \quad b = 4").scale(1.1).shift(band_shift(5) + UP * 1.1)
        b5_l2 = MathTex(r"x^3 - 64 = (x - 4)(x^2 + 4x + 16)").scale(1.1).shift(band_shift(5) + UP * 0.1)
        self.play(Write(b5_l1))
        self.wait(2)
        self.play(Write(b5_l2))
        self.play(Create(SurroundingRectangle(b5_l2, color=GREEN)))
        self.wait(2.5)
        b5_l3 = Tex(r"Squares vs cubes: read the exponent first").scale(1.05).shift(band_shift(5) + DOWN * 1.0)
        b5_l4 = MathTex(r"x^2 - 16 = (x-4)(x+4) \;\text{ — both linear}").scale(1.0).shift(band_shift(5) + DOWN * 1.9)
        ...
        self.next_band(6)
        b6_title = Tex(r"Factorise fully: $5x^3 - 40$").scale(1.2).shift(band_shift(6) + UP * 2.2)
        self.play(Write(b6_title))
        self.wait(1.5)
        b6_l1 = MathTex(r"= 5(x^3 - 8)").scale(1.1).shift(band_shift(6) + UP * 1.1)
        b6_l2 = MathTex(r"= 5(x - 2)(x^2 + 2x + 4)").scale(1.1).shift(band_shift(6) + UP * 0.2)
        ...
        self.wait(2)
        b7_l1 = Tex(r"$2 \times 2 \times 2 = 8$ sugar cubes fill a perfect box").scale(1.0).shift(band_shift(7) + UP * 1.1)
        b7_l2 = MathTex(r"1,\; 8,\; 27,\; 64,\; 125,\; 216 \;\text{ — the whole vocabulary}").scale(1.0).shift(band_shift(7) + UP * 0.2)
        ...
        self.wait(2)
        b7_l4 = Tex(r"Every old tool bounces off — the arrow points at cubes").scale(1.0).shift(band_shift(7) + DOWN * 2.0)
        ...
        self.wait(2)
        b8_l4 = Tex(r"Multiply back: the middles settle like a debt").scale(0.95).shift(band_shift(8) + DOWN * 1.8)
        b8_l5 = Tex(r"repaid the same day. Middle is $2x$, never $4x$").scale(0.95).shift(band_shift(8) + DOWN * 2.6)
        ...
        self.wait(2)
        b9_l1 = MathTex(r"x^3 - 64 = (x - 4)(x^2 + 4x + 16)").scale(1.05).shift(band_shift(9) + UP * 1.2)
        self.play(Write(b9_l1))
        self.wait(2)
        b9_l2 = MathTex(r"5x^3 - 40 = 5(x^3 - 8)").scale(1.05).shift(band_shift(9) + UP * 0.3)
        b9_l3 = MathTex(r"= 5(x - 2)(x^2 + 2x + 4)").scale(1.05).shift(band_shift(9) + DOWN * 0.6)
        self.play(Write(b9_l2))
        self.wait(2)
        self.play(Write(b9_l3))
        self.play(Create(SurroundingRectangle(b9_l3, color=GREEN)))
        self.wait(2)
        b9_l4 = Tex(r"Curtain first — common factor, then pattern").scale(1.0).shift(band_shift(9) + DOWN * 1.6)
