...
# "Mapwork Paper Practice Run" (the session's own Kransfontein practice map).
...
class MapworkPaperPracticeSession(MovingCameraScene):
    ...
    def construct(self):
        ...
        # --- Band 0 (subtopic_1): meeting the practice map extract ---
        title = Tex("Mapwork Practice: the Kransfontein sheet").scale(1.1).to_edge(UP)
        self.play(Write(title))
        self.wait(2)
        b0_l1 = Tex(r"A town in a river valley below an escarpment").scale(1.0).shift(UP * 0.9)
        b0_l2 = Tex(r"Uitkyk plateau edge to the NW;").scale(1.0).shift(UP * 0.2)
        b0_l3 = Tex(r"beacon at 1512,6 m; Doringspruit below").scale(1.0).shift(DOWN * 0.5)
        ...
        b0_l6 = Tex(r"Today: every mapwork skill, question by question").scale(0.95).shift(DOWN * 2.9)
        self.play(Write(b0_l6))
        self.wait(3)

        # --- Band 1 (subtopic_2): Question 1 — ten quick marks ---
        self.next_band(1)
        b1_t = Tex("Q1: ten marks of automatic skills").scale(1.15).shift(band_shift(1) + UP * 2.2)
        self.play(Write(b1_t))
        self.wait(1.5)
        b1_l1 = Tex(r"Sheet codes: the degree square,").scale(1.0).shift(band_shift(1) + UP * 1.1)
        ...
        b1_l6 = Tex(r"read clockwise --- $135^\circ$ lies south-east").scale(1.0).shift(band_shift(1) + DOWN * 2.6)
        self.play(Write(b1_l5)); self.wait(1.6)
        self.play(Write(b1_l6))
        self.wait(3)

        # --- Band 2 (subtopic_3): Q2 — references and the spur ---
        self.next_band(2)
        b2_t = Tex("Q2: index, coordinates, the spur").scale(1.15).shift(band_shift(2) + UP * 2.2)
        self.play(Write(b2_t))
        self.wait(1.5)
        b2_l1 = Tex(r"Coordinates: latitude first, then longitude;").scale(0.95).shift(band_shift(2) + UP * 1.1)
        ...
        # spur: nested contour Vs pointing right, path riding the crest
        ...
        l_spur = Tex(r"spur: high ground between valleys,\\the path rides its crest").scale(0.9).shift(sc2 + RIGHT * 3.4)
        self.play(Write(l_spur))
        self.wait(3)

        # --- Band 3 (subtopic_4): the gradient calculation, step by step ---
        self.next_band(3)
        b3_t = Tex("Q3: average gradient, A to B").scale(1.15).shift(band_shift(3) + UP * 2.2)
        self.play(Write(b3_t))
        self.wait(1.5)
        b3_f = MathTex(r"\text{Gradient} = \frac{\text{VI}}{\text{HE}}").scale(1.15).shift(band_shift(3) + UP * 1.2)
        self.play(Write(b3_f)); self.wait(2)
        b3_l1 = MathTex(r"\text{VI} = 1512{,}6 - 1260 = 252{,}6\ \text{m}").scale(1.1).shift(band_shift(3) + UP * 0.2)
        self.play(Write(b3_l1)); self.wait(2)
        b3_l2 = MathTex(r"\text{HE} = 4{,}2\ \text{cm} \times 500 = 2100\ \text{m}").scale(1.1).shift(band_shift(3) + DOWN * 0.7)
        self.play(Write(b3_l2)); self.wait(2)
        b3_l3 = MathTex(r"\text{Gradient} = \frac{252{,}6}{2100}").scale(1.1).shift(band_shift(3) + DOWN * 1.7)
        self.play(Write(b3_l3)); self.wait(2)
        b3_l4 = MathTex(r"= 1 : 8{,}3").scale(1.2).shift(band_shift(3) + DOWN * 2.7)
        self.play(Write(b3_l4))
        self.play(Create(SurroundingRectangle(b3_l4, color=GREEN)))
        self.wait(3)

        # --- Band 4 (subtopic_4): how the practice marking pays ---
        self.next_band(4)
        b4_t = Tex("Marked step by step: five steps").scale(1.15).shift(band_shift(4) + UP * 2.2)
        ...
        b4_l2 = Tex(r"Tolerance: 4,1--4,3 cm; answer 1:8,1--1:8,5").scale(1.0).shift(band_shift(4) + UP * 0.3)
        ...
        self.wait(2)
        b4_l4 = Tex(r"Path route: winds along the spur in curves,").scale(0.95).shift(band_shift(4) + DOWN * 2.3)
        b4_l5 = Tex(r"avoiding the contour-crowded valley heads").scale(0.95).shift(band_shift(4) + DOWN * 3.0)
        ...
        self.next_band(5)
        b5_t = Tex("Q4: vertical exaggeration").scale(1.2).shift(band_shift(5) + UP * 2.2)
        ...
        b5_l1 = MathTex(r"= \frac{1/5\,000}{1/50\,000}").scale(1.1).shift(band_shift(5) + UP * 0.0)
        self.play(Write(b5_l1)); self.wait(2)
        b5_l2 = MathTex(r"= \frac{50\,000}{5\,000} = 10\ \text{times}").scale(1.1).shift(band_shift(5) + DOWN * 1.0)
        self.play(Write(b5_l2))
        self.play(Create(SurroundingRectangle(b5_l2, color=GREEN)))
        self.wait(2)
        b5_l3 = Tex(r"Say TIMES --- not 10, not 1:10").scale(1.05).shift(band_shift(5) + DOWN * 2.0)
        ...
        self.next_band(6)
        b6_t = Tex("Q5: why the farmer at M fears clear nights").scale(1.05).shift(band_shift(6) + UP * 2.2)
        ...
        self.wait(1.5)
        b6_l1 = Tex(r"Inversion: milder air rests above the cold pool").scale(0.95).shift(sc6 + DOWN * 2.0)
        ...
        self.wait(1.5)
        b7_l1 = Tex(r"Southern Hemisphere: the north-facing slope").scale(1.0).shift(band_shift(7) + UP * 1.1)
        b7_l2 = Tex(r"drinks the midday sun --- warmer, larger stands").scale(0.95).shift(band_shift(7) + UP * 0.4)
        ...
        self.next_band(8)
        b8_t = Tex("Q6: GIS --- four ideas").scale(1.2).shift(band_shift(8) + UP * 2.2)
        ...
        l_buf = Tex(r"buffer the Doringspruit 100 m: flood-risk homes").scale(0.85).shift(sc8 + DOWN * 1.1)
        self.play(Write(l_buf))
        self.wait(3)

        # --- Band 9: the habit the whole session teaches ---
        self.next_band(9)
        ...
        b9_l3 = Tex(r"1 : 8,3 with working shown $=$ 5/5").scale(1.05).shift(band_shift(9) + DOWN * 0.7)
        self.play(Write(b9_l3))
        self.play(Create(SurroundingRectangle(b9_l3, color=GREEN)))
        self.wait(2)
        b9_l4 = Tex(r"Mapwork: the most predictable marks you own").scale(1.0).shift(band_shift(9) + DOWN * 1.7)
