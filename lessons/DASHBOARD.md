...
*Generated 2026-08-17 22:36 UTC by `lesson_pipeline.py dashboard` (regenerated hourly by Lesson 0 and on seed pushes — if this timestamp is old, check the Lesson 0 workflow).*
...
- pair `04b486`: primary `maths_g11_finance_growth_and_decay_revise_simple_and_compoun_04b486` (theme_generated) / secondary `maths_g11_finance_growth_and_decay_revise_simple_and_compoun_bbfc69` (theme_generated)
...
|---|---|---|---|---|---|---|---|---|
| groq | `llama-3.3-70b-versatile` | 67 | 25353 | 7770 | 33123 | 0 | 0 | 0 |
...
### By run (last 8 of 8 tagged runs)

| Run | Calls | Total tok | Retries | 429 hits | Failed |
|---|---|---|---|---|---|
| 31979746301 | 1 | 246 | 0 | 0 | 0 |
| 31977084810 | 1 | 310 | 0 | 0 | 0 |
| 31974147405 | 1 | 271 | 0 | 0 | 0 |
| 31971363584 | 1 | 254 | 0 | 0 | 0 |
| 31851300017 | 1 | 214 | 0 | 0 | 0 |
| 31847808216 | 1 | 177 | 0 | 0 | 0 |
| 31843775984 | 1 | 249 | 0 | 0 | 0 |
| 31839798578 | 1 | 259 | 0 | 0 | 0 |
| _untagged (legacy records)_ | 83 | 31143 | 0 | 0 | 0 |
