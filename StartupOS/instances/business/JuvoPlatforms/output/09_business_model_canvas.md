# Juvo Platforms (Pty) Ltd — Business Model Canvas
...
### A. Key Partners
1. **Core Suppliers**: Automated sourcing through certified vendors like **ROKCT (PlatformStack API), AWS (Serverless logistics compute), Google Maps API (routing and geocoding)**.
