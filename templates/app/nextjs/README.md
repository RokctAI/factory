...
`.rokct/config/app_type` (`{{APP_SLUG}}`, the slug of the name given in the
factory issue form): `core/utils/frappe/composer/{{APP_SLUG}}.json` in
...
Once base_sdk 1.35.0 is composed, add `data/` per the base docs.
