...
# Walk from this file to find the workspace root, then locate The-Rokct-Protocol
# This file lives at: .rokct/skills/agent_delegation/scripts/delegate_to_agent.py
_here = os.path.dirname(os.path.abspath(__file__))
# .rokct/  = 3 dirname levels up from scripts/
...
if not os.path.exists(_thenr):
    # Fallback: workspace_parent may not be correct; search upward
    _search = _workspace
    for _ in range(5):
...
import delegate_to_agent  # noqa: E402  (the shared copy)
